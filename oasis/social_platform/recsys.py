...
# 修改为 Hugging Face 官方模型 ID "Twitter/twhin-bert-base"
...
# twhin_tokenizer = AutoTokenizer.from_pretrained(pretrained_model_name_or_path="/mnt/petrelfs/renqibing/workspace/models/twhin-bert-base",model_max_length=512)
# twhin_model = AutoModel.from_pretrained(pretrained_model_name_or_path="/mnt/petrelfs/renqibing/workspace/models/twhin-bert-base").to(device)
